...
import {
  IndexerVesting as IndexerVestingEntity,
} from "../../generated/schema"

import {
  GraphTokenLockWallet,
} from "../../generated/Staking/GraphTokenLockWallet"
  ...
  _tryCreateEntity(): void {
    ...
    if(this.indexerVestingEntity == null) {
      ...
      if(!beneficiaryCall.reverted && !managedAmountCall.reverted) {
        this.indexerVestingEntity = new IndexerVestingEntity(this.address.toHex())
        this.indexerVestingEntity.beneficiary = beneficiaryCall.value
        this.indexerVestingEntity.managedAmount = tokenAmountToDecimal(managedAmountCall.value)
